...
private:
    schema::ComponentTypeBitset bitset = schema::getComponentTypeBitset({
        PositionComponent::COMPONENT_TYPE_ID,
...
public:
    ...
    void onUpdate(const std::vector<schema::EntityId>& eIds) override {
        ...
        for (const auto& eId : eIds) {
            schema::ComponentId posId = schema::entityComponentMap[eId][PositionComponent::COMPONENT_TYPE_ID];
            schema::ComponentId velId = schema::entityComponentMap[eId][VelocityComponent::COMPONENT_TYPE_ID];
